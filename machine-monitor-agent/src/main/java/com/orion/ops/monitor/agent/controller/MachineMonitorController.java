package com.orion.ops.monitor.agent.controller;

import com.orion.lang.utils.Valid;
import com.orion.ops.monitor.agent.constant.Currents;
import com.orion.ops.monitor.agent.metrics.statistics.CpuMetricsStatisticResolver;
import com.orion.ops.monitor.agent.metrics.statistics.DiskMetricsStatisticResolver;
import com.orion.ops.monitor.agent.metrics.statistics.MemoryMetricsStatisticResolver;
import com.orion.ops.monitor.agent.metrics.statistics.NetMetricsStatisticResolver;
import com.orion.ops.monitor.common.annotation.IgnoreLog;
import com.orion.ops.monitor.common.annotation.RestWrapper;
import com.orion.ops.monitor.common.constant.GranularityType;
import com.orion.ops.monitor.common.entity.agent.request.MetricsStatisticsRequest;
import com.orion.ops.monitor.common.entity.agent.vo.CpuMetricsStatisticsVO;
import com.orion.ops.monitor.common.entity.agent.vo.DiskMetricsStatisticVO;
import com.orion.ops.monitor.common.entity.agent.vo.MemoryMetricsStatisticsVO;
import com.orion.ops.monitor.common.entity.agent.vo.NetBandwidthMetricsStatisticVO;
